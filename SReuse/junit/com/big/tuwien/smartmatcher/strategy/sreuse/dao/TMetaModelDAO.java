...
public class TMetaModelDAO {
	private String container = "TMetaModelDAO.dbxml";
	
	public TMetaModelDAO() {
	...
	@Test
	public void testMetaModelSave() throws Exception {
		...
		String xml = mmDao.query("collection(\"" + container + "\")/metamodel");
