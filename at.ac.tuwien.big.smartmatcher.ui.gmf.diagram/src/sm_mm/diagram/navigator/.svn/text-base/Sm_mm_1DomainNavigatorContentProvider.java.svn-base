 ...
 * @generated
 */
public class Sm_mm_1DomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public Sm_mm_1DomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof sm_mm.diagram.navigator.Sm_mm_1DomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier
							.getChildren(((sm_mm.diagram.navigator.Sm_mm_1DomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result
						.add(new sm_mm.diagram.navigator.Sm_mm_1DomainNavigatorItem(
