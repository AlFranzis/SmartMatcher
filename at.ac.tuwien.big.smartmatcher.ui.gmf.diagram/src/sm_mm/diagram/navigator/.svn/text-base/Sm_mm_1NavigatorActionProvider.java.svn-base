 ...
 * @generated
 */
public class Sm_mm_1NavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					sm_mm.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof sm_mm.diagram.navigator.Sm_mm_1NavigatorItem) {
					selectedElement = ((sm_mm.diagram.navigator.Sm_mm_1NavigatorItem) selectedElement)
							.getView();
