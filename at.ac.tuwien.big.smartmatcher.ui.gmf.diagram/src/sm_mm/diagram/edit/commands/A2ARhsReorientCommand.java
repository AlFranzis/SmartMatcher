 ...
 * @generated
 */
public class A2ARhsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public A2ARhsReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return sm_mm.diagram.edit.policies.Sm_mm_1BaseItemSemanticEditPolicy.LinkConstraints
				.canExistA2ARhs_4004(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return sm_mm.diagram.edit.policies.Sm_mm_1BaseItemSemanticEditPolicy.LinkConstraints
				.canExistA2ARhs_4004(getOldSource(), getNewTarget());
	}
