 ...
 * @generated
 */
public class C2CLhsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public C2CLhsReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return sm_mm.diagram.edit.policies.Sm_mm_1BaseItemSemanticEditPolicy.LinkConstraints
				.canExistC2CLhs_4001(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return sm_mm.diagram.edit.policies.Sm_mm_1BaseItemSemanticEditPolicy.LinkConstraints
				.canExistC2CLhs_4001(getOldSource(), getNewTarget());
	}
