...
public class ClassSupertypesReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof sm_mm.Class) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return sm_mm.diagram.edit.policies.Sm_mm_1BaseItemSemanticEditPolicy.LinkConstraints
				.canExistClassSupertypes_4009(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return sm_mm.diagram.edit.policies.Sm_mm_1BaseItemSemanticEditPolicy.LinkConstraints
				.canExistClassSupertypes_4009(getOldSource(), getNewTarget());
	}
	...
	protected sm_mm.Class getOldSource() {
		return (sm_mm.Class) referenceOwner;
	}
