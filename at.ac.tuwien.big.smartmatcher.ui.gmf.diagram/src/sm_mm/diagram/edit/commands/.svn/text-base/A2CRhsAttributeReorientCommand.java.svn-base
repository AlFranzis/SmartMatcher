 ...
 * @generated
 */
public class A2CRhsAttributeReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public A2CRhsAttributeReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return sm_mm.diagram.edit.policies.Sm_mm_1BaseItemSemanticEditPolicy.LinkConstraints
				.canExistA2CRhsAttribute_4011(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return sm_mm.diagram.edit.policies.Sm_mm_1BaseItemSemanticEditPolicy.LinkConstraints
				.canExistA2CRhsAttribute_4011(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setRhsAttribute(null);
		getNewSource().setRhsAttribute(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setRhsAttribute(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
