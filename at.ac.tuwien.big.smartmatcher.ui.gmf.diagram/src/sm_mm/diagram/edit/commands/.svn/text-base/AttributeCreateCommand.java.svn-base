...
public class AttributeCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		sm_mm.Attribute newElement = sm_mm.Sm_mmFactory.eINSTANCE
				.createAttribute();

		sm_mm.Class owner = (sm_mm.Class) getElementToEdit();
	 ...
	 * @generated
	 */
	protected void doConfigure(sm_mm.Attribute newElement,
