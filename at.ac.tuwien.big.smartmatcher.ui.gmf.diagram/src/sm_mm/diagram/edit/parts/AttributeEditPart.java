...
public class AttributeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new sm_mm.diagram.edit.policies.AttributeItemSemanticEditPolicy());
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				if (child.getEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE) == null) {
					if (child instanceof ITextAwareEditPart) {
						return new sm_mm.diagram.edit.policies.Sm_mm_1TextSelectionEditPolicy();
					}
				}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof sm_mm.diagram.edit.parts.AttributeNameEditPart) {
			((sm_mm.diagram.edit.parts.AttributeNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(sm_mm.diagram.part.Sm_mm_1VisualIDRegistry
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForSource(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (relationshipType == sm_mm.diagram.providers.Sm_mm_1ElementTypes.A2ALhs_4003) {
			types.add(sm_mm.diagram.providers.Sm_mm_1ElementTypes.A2A_2002);
		}
		if (relationshipType == sm_mm.diagram.providers.Sm_mm_1ElementTypes.A2ARhs_4004) {
			types.add(sm_mm.diagram.providers.Sm_mm_1ElementTypes.A2A_2002);
		}
