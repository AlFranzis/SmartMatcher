 ...
 * @generated
 */
public class R2REditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new sm_mm.diagram.edit.policies.R2RItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		R2RFigure figure = new R2RFigure();
	 ...
	 * @generated
	 */
	public R2RFigure getPrimaryShape() {
		return (R2RFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class R2RFigure extends Ellipse {
		...
		private void createContents() {
			...
			WrappingLabel r2RNameFigure0 = new WrappingLabel();
			r2RNameFigure0.setText("R2R");

			this.add(r2RNameFigure0);
