 ...
 * @generated
 */
public class A2AEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new sm_mm.diagram.edit.policies.A2AItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		C2CFigure figure = new C2CFigure();
	 ...
	 * @generated
	 */
	public C2CFigure getPrimaryShape() {
		return (C2CFigure) primaryShape;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForTarget(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (relationshipType == sm_mm.diagram.providers.Sm_mm_1ElementTypes.C2CLhs_4001) {
			types.add(sm_mm.diagram.providers.Sm_mm_1ElementTypes.Class_2001);
		}
		if (relationshipType == sm_mm.diagram.providers.Sm_mm_1ElementTypes.C2CRhs_4002) {
			types.add(sm_mm.diagram.providers.Sm_mm_1ElementTypes.Class_2001);
		}
	 ...
	 * @generated
	 */
	public class C2CFigure extends Ellipse {
		...
		private void createContents() {
			...
			WrappingLabel c2CNameFigure0 = new WrappingLabel();
			c2CNameFigure0.setText("C2C");

			this.add(c2CNameFigure0);
