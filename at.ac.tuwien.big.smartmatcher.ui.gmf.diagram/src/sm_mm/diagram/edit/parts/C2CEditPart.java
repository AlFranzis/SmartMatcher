 ...
 * @generated
 */
public class C2CEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new sm_mm.diagram.edit.policies.C2CItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		A2AFigure figure = new A2AFigure();
	 ...
	 * @generated
	 */
	public A2AFigure getPrimaryShape() {
		return (A2AFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class A2AFigure extends Ellipse {
		...
		private void createContents() {
			...
			WrappingLabel a2ANameFigure0 = new WrappingLabel();
			a2ANameFigure0.setText("A2A");

			this.add(a2ANameFigure0);
