...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new sm_mm.diagram.edit.policies.ClassItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof sm_mm.diagram.edit.parts.ClassNameEditPart) {
			((sm_mm.diagram.edit.parts.ClassNameEditPart) childEditPart)
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof sm_mm.diagram.edit.parts.ClassEditPart) {
			types
					.add(sm_mm.diagram.providers.Sm_mm_1ElementTypes.Reference_4006);
		}
		if (targetEditPart instanceof sm_mm.diagram.edit.parts.ClassEditPart) {
			types
					.add(sm_mm.diagram.providers.Sm_mm_1ElementTypes.ClassSupertypes_4009);
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMATypesForTarget(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (relationshipType == sm_mm.diagram.providers.Sm_mm_1ElementTypes.Reference_4006) {
			types.add(sm_mm.diagram.providers.Sm_mm_1ElementTypes.Class_2001);
		}
		if (relationshipType == sm_mm.diagram.providers.Sm_mm_1ElementTypes.ClassSupertypes_4009) {
			types.add(sm_mm.diagram.providers.Sm_mm_1ElementTypes.Class_2001);
		}
		return types;
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == sm_mm.diagram.providers.Sm_mm_1ElementTypes.Attribute_3001) {
				return getChildBySemanticHint(sm_mm.diagram.part.Sm_mm_1VisualIDRegistry
