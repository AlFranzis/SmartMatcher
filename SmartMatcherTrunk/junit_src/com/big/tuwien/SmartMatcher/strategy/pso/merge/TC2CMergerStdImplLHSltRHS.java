 ...
 * for LHS and RHS meta-models where the LHS has less classes than the RHS.
 * No methods of the merger are overwritten. 
 * @author alex
 *
 */ 
public class TC2CMergerStdImplLHSltRHS extends QueryBuilder {
	private LhsMM lhsMM;
	private RhsMM rhsMM;
	 
	
	public TC2CMergerStdImplLHSltRHS() {
