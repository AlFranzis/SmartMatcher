 ...
 * the LHS has less classes than the RHS. 
 * @author alex
 *
 */
public class TC2CMergerLHSltRHS extends QueryBuilder {
	private LhsMM lhsMM;
	private RhsMM rhsMM;
	 
	
	public TC2CMergerLHSltRHS() {
	...
	public void testRemoval1() {
		...
		C2CMerger replacer = new C2CMerger(
			...
			protected Merge<PSOC2C> pick(ExtPSOMapping m1, ExtPSOMapping m2) {
				...
				return new Removal<PSOC2C>(Side.RHS(), m1C2C);
			}
	...
	public void testReplacement1() {
		...
		C2CMerger replacer = new C2CMerger(
			...
			protected Merge<PSOC2C> pick(ExtPSOMapping m1, ExtPSOMapping m2) {
				...
				return new Replacement<PSOC2C>(Side.RHS(), m1C2C, m2C2C);
			}
	...
	public void testInsert1() {
		...
		C2CMerger replacer = new C2CMerger(
			...
			protected Merge<PSOC2C> pick(ExtPSOMapping m1, ExtPSOMapping m2) {
				...
				return new Insert<PSOC2C>(Side.RHS(), m2C2C);
			}
