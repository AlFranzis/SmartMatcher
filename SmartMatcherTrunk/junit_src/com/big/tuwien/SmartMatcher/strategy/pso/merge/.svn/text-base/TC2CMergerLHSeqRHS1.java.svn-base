...
/**
 * Tests the {@link C2CReplacer} for LHS and RHS meta-models that have EQUAL
 * number of classes.
 * @author alex
 *
 */
public class TC2CMergerLHSeqRHS1 extends QueryBuilder {
	private LhsMM lhsMM;
	private RhsMM rhsMM;
	 
	
	public TC2CMergerLHSeqRHS1() {
	...
	public void testSimpleReplace1() {
		...
		// check that merged mapping contains 2 R2Rs
		assertEquals(2, merged.descendents(PSOR2R.class).size());
