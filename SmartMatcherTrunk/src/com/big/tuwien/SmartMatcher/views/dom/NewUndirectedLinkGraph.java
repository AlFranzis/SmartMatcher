...
public class NewUndirectedLinkGraph extends LinkGraph {
	protected Graph<Element,DefaultEdge> graph;
	
	
	@Override
	public void build() {
		DirectedGraph<Element,DefaultEdge> graph = new DefaultDirectedGraph<Element, DefaultEdge>(DefaultEdge.class);
		...
		// turns the directed graph into an undirected one
		this.graph = new AsUndirectedGraph<Element, DefaultEdge>(graph);
	}
