...
/**
 * This is the item provider adapter for a {@link sm_mm.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Sm_mmPackage.Literals.CLASS__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Sm_mmPackage.Literals.CLASS__SUPERTYPES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Sm_mmPackage.Literals.CLASS__ATTRIBUTES);
		}
	...
	public String getText(Object object) {
		String label = ((sm_mm.Class)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(sm_mm.Class.class)) {
			case Sm_mmPackage.CLASS__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Sm_mmPackage.CLASS__ATTRIBUTES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Sm_mmPackage.Literals.CLASS__ATTRIBUTES,
				 Sm_mmFactory.eINSTANCE.createAttribute()));
	}
