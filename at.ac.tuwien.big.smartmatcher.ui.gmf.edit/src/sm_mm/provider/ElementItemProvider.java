...
/**
 * This is the item provider adapter for a {@link sm_mm.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_lhs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_lhs_feature", "_UI_Element_type"),
				 Sm_mmPackage.Literals.ELEMENT__LHS,
				 true,
				 false,
				 false,
	...
	protected void addRhsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_rhs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_rhs_feature", "_UI_Element_type"),
				 Sm_mmPackage.Literals.ELEMENT__RHS,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Element_type") + " " + element.isLhs();
	}
