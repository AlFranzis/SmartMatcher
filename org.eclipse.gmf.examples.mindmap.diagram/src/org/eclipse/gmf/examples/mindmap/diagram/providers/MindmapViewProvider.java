 ...
 * @generated
 */
public class MindmapViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return MapEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = MindmapVisualIDRegistry.getNodeVisualID(op
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(MapEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (MindmapVisualIDRegistry.getVisualID(elementTypeHint)) {
		case TopicSubtopicsEditPart.VISUAL_ID:
			return createTopicSubtopics_4001(containerView, index, persisted,
					preferencesHint);
		}
	...
	public Node createTopic_2001(EObject domainElement, View containerView,
		...
		node.setType(MindmapVisualIDRegistry.getType(TopicEditPart.VISUAL_ID));
		...
		Node label5001 = createLabel(node, MindmapVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createTopicSubtopics_4001(View containerView, int index,
		...
		edge.setType(MindmapVisualIDRegistry
