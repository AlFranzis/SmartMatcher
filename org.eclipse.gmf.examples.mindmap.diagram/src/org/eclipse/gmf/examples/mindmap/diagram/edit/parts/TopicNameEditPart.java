...
public class TopicNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new MindmapTextSelectionEditPolicy());
	...
	public void setLabelText(String text) {
		...
		if (sfEditPolicy instanceof MindmapTextSelectionEditPolicy) {
			((MindmapTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MindmapParserProvider
					.getParser(
							MindmapElementTypes.Topic_2001,
							getParserElement(),
							MindmapVisualIDRegistry
									.getType(org.eclipse.gmf.examples.mindmap.diagram.edit.parts.TopicNameEditPart.VISUAL_ID));
		}
		return parser;
	}
