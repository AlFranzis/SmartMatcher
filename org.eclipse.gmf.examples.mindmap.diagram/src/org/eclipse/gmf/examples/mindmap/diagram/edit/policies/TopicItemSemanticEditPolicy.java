...
public class TopicItemSemanticEditPolicy extends
	...
	public TopicItemSemanticEditPolicy() {
		super(MindmapElementTypes.Topic_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MindmapVisualIDRegistry.getVisualID(incomingLink) == TopicSubtopicsEditPart.VISUAL_ID) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MindmapVisualIDRegistry.getVisualID(outgoingLink) == TopicSubtopicsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
