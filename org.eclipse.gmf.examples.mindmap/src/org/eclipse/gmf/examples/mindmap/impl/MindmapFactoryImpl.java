...
public class MindmapFactoryImpl extends EFactoryImpl implements MindmapFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MindmapPackage.DOCUMENT_ROOT: return (EObject)createDocumentRoot();
			case MindmapPackage.MAP: return (EObject)createMap();
			case MindmapPackage.RELATIONSHIP: return (EObject)createRelationship();
			case MindmapPackage.RESOURCE: return (EObject)createResource();
			case MindmapPackage.THREAD: return (EObject)createThread();
			case MindmapPackage.THREAD_ITEM: return (EObject)createThreadItem();
			case MindmapPackage.TOPIC: return (EObject)createTopic();
			default:
